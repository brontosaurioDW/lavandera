		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 d-sm-none d-md-block">
					...
					<p class="cover-country"><span>Buenos Aires</span> Argentina</p>
				</div>
			</div>
		</div>
	</div>
...
<section class="dates">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12">
				<a href="#" class="next-concerts">Ver todos los conciertos <i class="fal fa-long-arrow-right"></i></a>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-sm-12 news-container">
				...
				<ul class="news-list row">
					<li class="news-single col-sm-12 col-md-4">
						<div>
